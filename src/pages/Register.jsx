...
import { Eye, EyeOff, Mail, Lock, User, Briefcase, ArrowLeft, Brain, Target, Users, TrendingUp, CheckCircle } from 'lucide-react';
...
const Register = () => {
  ...
  const handleProfilePictureChange = (file, imageUrl) => {
    setFormData(prev => ({
      ...prev,
      profilePicture: file,
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-900 p-12 flex-col justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md mx-auto">
          ...
          <p className="text-gray-700 text-lg mb-8 leading-relaxed">
            Join our community of professionals and transform your interview skills with AI-powered practice sessions, personalized feedback, and expert guidance.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            <div className="text-center mb-8">
              <div className="mx-auto h-16 w-16 bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl flex items-center justify-center shadow-lg mb-4">
                <svg 
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full pl-10 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl transition-all duration-300 focus:outline-none focus:ring-0 focus:border-gray-500 hover:border-gray-300 text-gray-900"
                  >
